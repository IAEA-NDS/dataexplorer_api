...
app =   Flask(__name__)
# ripl3_api = Blueprint('burritos', __name__,)
...
@app.route('/levels/<string:nuclide>') #, methods = ['GET'])
def nuclide(nuclide):
...
@app.route('/levels/<string:nuclide>/info') #, methods = ['GET'])
...
@app.route('/levels/<string:nuclide>/levels') #, methods = ['GET'])
...
@app.route('/levels/<string:nuclide>/level_record/levelnum/<string:levelnum>') #, methods = ['GET'])
